(function () {
  ...
  const links = [["GitHub", "程式碼與開源專案", "https://github.com/Lian0123"], ["Medium", "近期工程文章", "https://medium.com/@lian000123"], ["SlideShare", "技術教材與研究簡報", "https://www.slideshare.net/ssuser6090c0"], ["Zenn", "日文技術內容", "https://zenn.dev/lian0123"], ["DEV Community", "開發者社群文章", "https://dev.to/lian0123"]];
  ...
  function Card({ item, action }) {
    return e("article", { className:"work-card" },
      ...
      e("h3", null, item.title), e("p", null, item.description),
  ...
  function App() {
    ...
    return e("div", { className:"site" },
      e("header", { className:"topbar" }, e("div", { className:"topbar-inner" }, e("a", { className:"brand", href:"#top" }, "LIAN / 0123"), e("nav", { "aria-label":"主要導覽" }, e("ul", { className:"nav-list" }, [["about","關於"],["projects","作品"],["writing","工程著作"],["other","其他創作"],["links","連結"]].map(x=>e("li", {key:x[0]}, e("a", {className:"nav-link",href:"#"+x[0]},x[1]))))), e("button", { className:"theme-toggle", onClick:()=>setTheme(theme === "dark" ? "light" : "dark"), "aria-label":"切換明暗主題" }, theme === "dark" ? "☀" : "◐"))),
      e("main", { id:"content" },
        ...
        e("section", { id:"projects", className:"content-section" }, Heading("03 / ENGINEERING", "工程開發", "依創作階段整理的公開專案與可操作作品。"), e("div", { className:"filter-row" }, [["all","全部"],["after","工作後"],["university","大學"]].map(x=>e("button",{key:x[0],className:"filter-button"+(filter===x[0]?" active":""),onClick:()=>setFilter(x[0])},x[1]))), e("div", { className:"work-grid" }, filtered.map(x=>e(Card,{key:x.title,item:x,action:"查看專案"})))),
